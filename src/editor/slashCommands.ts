...
export const slashCommands: SlashCommand[] = [
  ...
  },
  {
    id: "lorem",
    title: "Lorem ipsum",
    hint: "Insert a paragraph of placeholder text",
    icon: Type,
    keywords: ["lorem", "ipsum", "placeholder", "sample"],
    run: (editor, range) => editor.chain().focus().deleteRange(range).setParagraph().insertContent({
      type: "text",
