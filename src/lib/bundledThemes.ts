...
export const builtInThemeDocuments = [...classic, minimal, saratoga, based, starfall, oldBasementPC, adventure, typewriter];
const legacy = loadThemeCatalog(classic);
const bundled = loadThemeCatalog([minimal, saratoga, based, starfall, oldBasementPC, adventure, typewriter]);
